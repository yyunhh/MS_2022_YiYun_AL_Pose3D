'''
Need this file to load into debug.py for H36M dataloader
'''
...
class opts():
  def __init__(self):
    ...
    self.parser.add_argument('--demo', default = '../tryimage/', help = 'path/to/image') #'D:\Research\AL_Research\data\h36m\ECCV18_Challenge\ECCV18_Challenge\Val\IMG', help = 'path/to/image')
    ...
    self.parser.add_argument('--batch_size', type=int, default=4) #32
