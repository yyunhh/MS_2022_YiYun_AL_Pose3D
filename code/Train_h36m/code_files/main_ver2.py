...
def main(opt,conf):
    ...
    if conf.mpi_inf_3dhp:
        print("run active learning on mpi_inf_3dhp dataset")
        mpi_inf_3dhp_Data = mpi_inf_3dhp_AL(mpi_inf_3dhp_dict = mpi_inf_3dhp, active_learning_obj = active_learning_obj, getitem_dump =conf.model_save_path, conf = conf, **args)
        print("check mpi_inf_3dhp dataset: ", len(mpi_inf_3dhp_Data))
