...
class ParseConfig(object):
    ...
    def __init__(self):
        ...
        if self.success:
            ...
            os.makedirs(os.path.join(self.model_save_path[:-20], 'checkpoint'), exist_ok=True)
        ...
        if self.success:
            ...
            self.pick_index_AL = conf_yml['pick_index_AL']
            ...
            # pick_3D
            self.pick_3D = conf_yml['pick_3D']
            self.model_load_pre_3D = conf_yml['model_load_pre_3D']
            self.model_load_now_3D = conf_yml['model_load_now_3D']
            ...
            self.active_learning_mode = conf_yml['active_learning']['mode']
            
            self.precached_mpii = conf_yml['precached_mpii']
            self.precached_h36m = conf_yml['precached_h36m']
            self.mpi_inf_3dhp = conf_yml['mpi_inf_3dhp']
          
            # 3D favor
            self.train_3D = conf_yml['train_3D']
            self.metric_3D = conf_yml['metric_3D']
            self.test_3D_simple = conf_yml['test_3D_simple']
            self.train_3D_simple = conf_yml['train_3D_simple']
